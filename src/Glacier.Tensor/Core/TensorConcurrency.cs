...
/// <summary>
/// Provides global and ambient concurrency configuration for Glacier.Tensor operations,
/// enabling dynamic scaling or throttling across CPU hardware cores.
/// </summary>
public static class TensorConcurrency
{
    private static int _maxDegreeOfParallelism = 0;

    /// <summary>
    /// Gets or sets the global maximum degree of parallelism for Glacier.Tensor operations.
    /// <list type="bullet">
